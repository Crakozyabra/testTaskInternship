...
public class OtherPlayerController {
    ...
    public Integer getPlayersCount(@RequestParam(required = false) String name,
        ...
        return otherPlayerService.getPlayersCount(
                name,
                title,
                race,
                profession,
    ...
    public ResponseEntity<Player> createPlayer(@RequestBody PlayerInfo info) {
        ...
        Player player = otherPlayerService.createPlayer(info.name, info.title, info.race, info.profession, info.birthday, info.banned, info.experience);
    ...
    public ResponseEntity<Player> getPlayerById(@PathVariable("ID") long id) {
        ...
        Player player;
        try {
            player = otherPlayerService.getPlayerById(id);
        } catch (Exception e) {
    ...
    public ResponseEntity delete(@PathVariable("ID") long id) {
        ...
        Player player = otherPlayerService.deletePlayer(id);
        if (isNull(player)) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(null);
        } else {
