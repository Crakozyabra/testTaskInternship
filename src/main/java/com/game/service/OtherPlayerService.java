...
public class OtherPlayerService {
    ...
    public List<Player> getPlayers(
        ...
        List<Player> players = otherPlayerRepository.findAll();
    ...
    public Player getPlayerById(Long id) {
        return otherPlayerRepository.findById(id).get();
    }
    ...
    public Player updatePlayer(long id, String name, String title, Race race, Profession profession, Long birthday, Boolean banned, Integer experience) {
        ...
        try {
            playerById = otherPlayerRepository.findById(id).get();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public Player deletePlayer(long id) {
        Player player = otherPlayerRepository.findById(id).orElse(null);
        if (isNull(player)) {
            return null;
        }

        otherPlayerRepository.deleteById(id);
        return player;
    }
